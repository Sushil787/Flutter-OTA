...
///
/// `UPLOAD_TOKEN` is accepted as well as `FLUTTER_OTA_TOKEN` because that is the
...
String? resolveToken(String? explicit, {required String appDir}) {
  ...
  for (final key in const ['FLUTTER_OTA_TOKEN', 'UPLOAD_TOKEN']) {
...
String resolveServer(
  ...
  final fromEnv = Platform.environment['FLUTTER_OTA_SERVER'];
  if (fromEnv != null && fromEnv.isNotEmpty) return fromEnv;

  final value = loadDotEnv(appDir: appDir)['FLUTTER_OTA_SERVER'];
