import 'package:flutroid_cli/src/android_patcher.dart';
...
''';
      ...
      expect(result.source, contains('FlutroidPatch.applyTo'));
...
''';
      ...
      expect(body.indexOf('FlutroidPatch.applyTo'), lessThan(body.lastIndexOf('}')));
    });
...
''';
      ...
      expect(body.indexOf('private val label'),
          lessThan(body.indexOf('FlutroidPatch.applyTo')));
    });
