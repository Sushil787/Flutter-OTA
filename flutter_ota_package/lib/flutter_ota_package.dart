/// Flutter OTA updater — the client half that runs inside the app.
///
...
/// for you by `flutter_ota init`.
library;

export 'src/flutter_ota.dart';
export 'src/flutter_ota_platform.dart';
export 'src/flutter_ota_progress.dart';
