...
/// Change this, rebuild, and ship it with `flutroid patch`. Seeing the new text
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // both stay current.
    return ValueListenableBuilder<FlutroidProgress>(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _StateCard(state: Flutroid.instance.state),
              ],
            ),
          ),
        ),
...
class _UpdateBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  static PreferredSizeWidget? of(FlutroidProgress update) =>
      update.stage == FlutroidStage.idle ? null : _UpdateBar(update: update);

  final FlutroidProgress update;
  ...
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    final color = update.stage == FlutroidStage.failed
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  ...
                  if (update.stage == FlutroidStage.downloading &&
                      update.total > 0)
                    Text(
